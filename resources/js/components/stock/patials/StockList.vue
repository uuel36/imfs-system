<template>
    <el-card class="box-card">
        <div  class="text item">
            ...
            <!-- Conditionally render the Show History button based on the user's role ID -->
            <el-button v-if="userRole !== 2" type="primary" @click="showHistory">Show History</el-button>
            <!-- Conditionally render the Add Stock button based on the user's role ID -->
            <el-button v-if="userRole !== 2" size="mini" type="primary" @click="addStock" style="float:right;">Add Stock</el-button>
            <el-input
                size="mini"
