    ...
    <div class="content-wrapper" :class="{ 'color-inverted': colorInversion, 'large-text': largeText, }">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1  :class="{ 'color-inverted': colorInversion}" class="page_title">DEPLOYED STOCKS INFO</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/home">Home</a></li>
                            <li class="breadcrumb-item active">Deployed Stocks</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <!-- Main content -->
            <section id="sidebar"  :class="{ 'color-inverted': colorInversion}"  class="content" >
                <div class="container-fluid">
